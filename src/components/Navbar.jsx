            ...
            <div className="navbar bg-base-100 shadow-sm lg:px-[8%]">
                ...
                <div className="navbar-end space-x-6">
                    ...
                    <div className="indicator">
                        ...
                        <span className="border-red-400 badge badge-sm indicator-item">8</span>
                    </div>

                    <button className="hover:text-green-500 hidden md:block">Login</button>

                    <a className="btn rounded-full text-amber-50 bg-linear-to-r from-[#4f39f6] via-[#7226f8] to-[#9514fa] hover:text-green-500">Get Started</a>
                </div>
            </div>
        </div>
    );
